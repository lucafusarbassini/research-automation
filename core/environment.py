...
def _get_conda_python(env_name, tool, run_cmd):
    ...
    try:
        ...
        return (
            ...
            else f"conda run -n {env_name} python"
        )
    except Exception:
...
def generate_requirements_txt(
    project_root: Path, env_info: dict, *, run_cmd=None
) -> Path:
    ...
    try:
        ...
        req_path.write_text(
            "# Auto-generated by ricet\n# Run: pip freeze > requirements.txt\n"
        )

    return req_path


def populate_encyclopedia_env(
    project_root: Path, env_info: dict, sys_info: SystemInfo = None
):
